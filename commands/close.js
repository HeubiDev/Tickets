...
module.exports = {
  ...
  async execute(interaction) {
    ...
    if (!ticket) {
      return interaction.reply({ content: 'Kein Ticket für diesen Channel gefunden.', ephemeral: true });
    }
    ...
    await interaction.reply({ content: 'Ticket geschlossen. Transkript wurde versendet.', ephemeral: true });
